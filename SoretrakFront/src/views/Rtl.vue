...
<script>
import ChartHolderCard from "../features/dashboard/components/ChartHolderCard.vue";
...
import MiniStatisticsCard from "../features/dashboard/components/MiniStatisticsCard.vue";
