...
import ValidationError from "@/components/MaterialComponents/ValidationError.vue";
...
export default {
  ...
  data() {
    return {
      user: {},
      file: null,
      imgSource: 'https://vue-material-dashboard-laravel-pro.creative-tim.com/images/placeholder.jpg',
      loading: null,
    }
  },
  mixins: [formMixin],
  computed: {
    getImage() {
      if (!this.user.profile_image || this.loading) return require("@/assets/images/placeholder.jpg")
