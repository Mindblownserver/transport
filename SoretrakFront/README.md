...
3. Create a new .env file: `cp .env.example .env`
4. `VUE_APP_BASE_URL` should contain the URL of your Vue Material Dashboard Project (eg. http://localhost:8081/)
...
vue-material-dashboard-2
    ...
    │   │   ├── MaterialComponents/MaterialCheckboxField.vue
    │   │   ├── MaterialComponents/MaterialInput.vue
    ...
    │   │   ├── MaterialComponents/MaterialSwitch.vue
    │   │   ├── MaterialTextarea.vue
    |   |   └── MaterialComponents/ValidationError.vue
    │   ├── examples
    │   │   ├── Cards
    │   │   ├── Charts
    │   │   ├── Navbars
